...
describe("Test route cats", () => {
  ...
  describe("GET request", () => {
    ...
    it("should return status 200 get by id cats", async () => {
  ...
  describe("PUT request", () => {
    it("should return status 200 update cat by id", async () => {
      const cat = await Cat.create({ ...newCat, owner: user._id });
      const response = await request(app)
  ...
  describe("DELETE request", () => {
    it("should return status 200 remove cat by id", async () => {
      const cat = await Cat.create({ ...newCat, owner: user._id });
      const response = await request(app)
